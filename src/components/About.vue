<template lang="pug">
  div(class="about_page")
    router-link(tag="button" to="/" class="about_return_button")
  ...
  */
  @media only screen and (min-width: 552px) {
    ...
    .about_layout {
      ...
      grid-template-areas: "facebook instagram website"
